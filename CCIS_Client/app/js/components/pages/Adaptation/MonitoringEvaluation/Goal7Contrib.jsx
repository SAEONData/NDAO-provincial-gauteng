...
class Goal7Contrib extends React.Component {
  ...
  async submit() {
    ...
    let { goalId, goalStatus, Q7_1, Q7_2, Q7_3 } = this.state
  ...
  render() {
    ...
    let { editing, goalStatus, goalId, Q7_1, Q7_2, Q7_3 } = this.state
        ...
        <Row style={{ marginLeft: "0px" }}>
          ...
          <Col md="11">
            ...
            <Row>
              <Col md="8">
                <label style={{ fontWeight: "bold" }}>
                  7.2 What is the effective region for this goal?
                </label>
                ...
                <OData
                  ...
                  {({ loading, error, data }) => {
                    ...
                    if (regions && regions.length > 0) {
                      let f = regions.filter(x => x.RegionId == Q7_3)
