...
namespace CCIS_API.Controllers
{
    ...
    [ODataRoutePrefix("Goal7")]
    [EnableCors("CORSPolicy")]
    public class Goal7Controller : ODataController
    {
        public SQLDBContext _context { get; }
        public Goal7Controller(SQLDBContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        [EnableQuery]
        public IQueryable<Goal7> Get()
        {
            return _context.Goal7.AsQueryable();
        }
        ...
        public async Task<IActionResult> Post([FromBody]Goal7 goal)
        {
            ...
            var exiting = _context.Goal7.FirstOrDefault(x => x.Id == goal.Id);
            if (exiting == null)
            {
